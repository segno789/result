...
<div id="header">
    <div class="inHeaderLogin">
        ...
        <p style="color: wheat;text-align: center;font-size: 22px;margin-left: 28px;float: left;     margin-top: 40px;">Board of Intermediate & Secondary Education, Gujranwala </br></br><?php echo VERIFICATION_TITLE ?> </p>
    </div>
</div>
